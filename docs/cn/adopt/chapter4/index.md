...
![飞书应用凭证页面](/lark-credential.png)

### 第四步：启用机器人能力

进入"添加应用能力" → "机器人"，点击"添加"。

![添加应用能力页面](/lark-app.png)
...
![飞书权限管理页面](/lark-authentication.png)

...
> - **Your Telegram user id**（用户 ID）：如 `8561283145`，这就是你的 **Chat ID**——请记下来，[第四章 定时任务](/cn/adopt/chapter4/)的 `--channel` 参数需要用到它
...
> ```
>
> 把 `8561283145` 替换成你自己的 Chat ID。详见[第四章 定时任务](/cn/adopt/chapter4/)。

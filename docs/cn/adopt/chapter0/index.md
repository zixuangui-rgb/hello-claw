...
当“百虾大战”的硝烟散去，一个更本质的问题浮出水面：我们到底在追捧什么？是又一个明星项目，还是 AI 交互范式的真正跃迁？答案藏在每一次“让它去做”而非“让它去说”的瞬间。下面，让我们把镜头拉近，看看这只“龙虾”究竟如何重新定义“助手”二字。
...
这种分层设计让 OpenClaw 既灵活又可控。你可以通过修改 SOUL.md 来定制 Agent 的性格和行为准则，通过 USER.md 和 MEMORY.md 让它认识你并记住你的偏好，通过安装不同的技能来扩展它的能力。详细介绍见[第九章 个人助理与内容创作](/cn/adopt/chapter9/)。
...
**Docker 部署**：适合生产环境，可实现环境隔离、版本管理、自动重启。详见[第七章](/cn/adopt/chapter7/)。

<details>
<summary>不想折腾安装？试试云端托管</summary>

如果你不想自己安装和配置：

- **飞书妙搭**：[一键创建](https://miaoda.feishu.cn/bot-landing)，云端部署 + 自动接入飞书机器人，内置飞书官方插件，限时每日赠送百万级 Tokens
- **ArkClaw**：火山引擎 [ArkClaw](https://www.volcengine.com/experience/ark?mode=claw)，需订阅 Coding Plan（Lite ¥9.90/月起，新用户 7 天免费试用）
...
如果你想先把“技能地图”看明白，再决定装哪些技能，建议先看 [龙虾大学：Skills 选修地图](/cn/adopt/lobster-university)。
...
**下一步**：[第一章 拥有你的第一个 QQ AI 助手](/cn/adopt/chapter1/)

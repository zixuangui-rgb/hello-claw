...
> **想跳过这些？** 如果你只想最快用上 AI 助手，[第一章](/cn/adopt/chapter1/)介绍了两个桌面客户端：**AutoClaw**（内置模型，零配置）和 **ClawX**（开源多平台，需自备 API Key），都无需终端操作。
...
> Windows 一键脚本已包含此步骤（且会直接进入配置向导），如果你用了一键脚本可以跳到[第 2 步](#_2-配置-ai-模型)查看配置说明。

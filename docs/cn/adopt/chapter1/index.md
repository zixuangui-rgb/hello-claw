...
![Preferences 设置页面](/autoclaw_preferences.png)
...
> **Tip**
> AutoClaw 就是完整版 OpenClaw。后续章节的场景配置在 AutoClaw 中同样适用。

**想要更多控制权？** 手动安装 OpenClaw → [第二章](/cn/adopt/chapter2/)

**想了解更多桌面客户端和替代方案？** → [附录 C：类 Claw 方案对比与选型](/cn/appendix/appendix-c)

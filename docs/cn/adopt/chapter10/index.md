...
![OpenClaw三层隔离方案](/OpenClaw三层隔离方案.png)
...
![OpenClaw 信任边界架构](/OpenClaw信任边界架构.png)
...
OpenClaw 社区使用 [MITRE ATLAS](https://atlas.mitre.org/)（AI 系统对抗性威胁图谱）框架对威胁进行系统分类。以下是按攻击阶段组织的主要威胁。

...
第三阶段"构建 Claw"（4-8 周）是深入理解原理，从零实现一个简化版的 AI Agent。你会学习 Agent Loop 和工具调用的核心机制，技能系统的解析和加载，多渠道消息适配器的设计，以及工作区 Markdown 文件（IDENTITY.md、SOUL.md、USER.md、AGENTS.md、TOOLS.md、MEMORY.md、HEARTBEAT.md）构成的记忆与身份系统。

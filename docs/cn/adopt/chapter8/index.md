...
>
> **零成本入门**：第一章推荐的 [OpenRouter](https://openrouter.ai) 提供免费模型（如 `stepfun/step-3.5-flash:free`），适合学习阶段。当你需要更多模型选择或更高速率时，推荐 [硅基流动（SiliconFlow）](https://cloud.siliconflow.cn)——新注册用户赠送 16 元算力券，支持支付宝/微信充值，可直接访问 DeepSeek、Qwen、GLM 等多家模型。详见[第一章第 2 节](/cn/adopt/chapter1/#_2-配置-ai-模型)。

...
1. **领养 Claw（使用篇）**：11 章 + 7 个附录，安装（Ch1-3）+ 场景配置（Ch4-11），装好后按需选读
...
- 零基础用户：从第一部分"领养 Claw"第 1 章开始，安装后按需选读场景配置章节
...
- **[2026-03-08]** ✅ 完成领养 Claw 第1-11章：安装（AutoClaw + 手动安装 + 配置向导）、场景配置（聊天平台接入、模型管理、智能体管理、工具与定时任务、网关运维、远程访问、安全防护、Web 界面）
